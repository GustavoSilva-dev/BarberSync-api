...
1. `GET` - Estruturar a rota get para listagem de serviços da barbearia, apenas serviços com `ativo = true`, não é necessário nenhum nível de autorização, utilize o **Page** para realizar a paginação do metódo a partir do dto `DadosRetornoServico`.
